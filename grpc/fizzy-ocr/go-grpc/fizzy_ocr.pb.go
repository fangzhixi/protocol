...
func (x *ResidentIdentityCardRsp) GetLogId() string {
	if x != nil {
		return x.LogId
	}
	return ""
...
func (x *ResidentIdentityCardResult) GetModelCode() int32 {
	if x != nil {
		return x.ModelCode
	}
	return 0
...
var file_fizzy_ocr_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x43, 0x6f,
